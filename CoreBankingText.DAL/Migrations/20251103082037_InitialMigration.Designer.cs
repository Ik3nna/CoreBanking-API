...
namespace CoreBanking.Infrastructure.Migrations
{
    ...
    [Migration("20251103082037_InitialMigration")]
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOpened = new DateTime(2025, 10, 14, 8, 20, 36, 699, DateTimeKind.Utc).AddTicks(1780),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CustomerId = new Guid("a1b2c3d4-1234-5678-9abc-123456789abc"),
                            DateCreated = new DateTime(2025, 10, 4, 8, 20, 36, 699, DateTimeKind.Utc).AddTicks(939),
