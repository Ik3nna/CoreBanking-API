...
namespace CoreBanking.Infrastructure.Repositories
{
    public class AccountRepository : IAccountRepository
    {
        ...
        {
            new AccountModel { Id = 1, Name = "John Doe", Balance = 5000, Currency = "NGN" },
            new AccountModel { Id = 2, Name = "Jane Smith", Balance = 8000, Currency = "NGN" }
        };
        ...
        public Task<IEnumerable<Account>> GetByCustomerIdAsync()
        {
            throw new NotImplementedException();
        }
