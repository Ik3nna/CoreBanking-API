...
using CoreBanking.Application.Account.EventHandlers;
...
            builder.Services.AddTransient<INotificationHandler<AccountCreatedEvent>, AccountCreatedEventHandler>();
            builder.Services.AddTransient<INotificationHandler<CoreBanking.Core.Events.MoneyTransferedEvent>, MoneyTransferedEventHandler>();
            builder.Services.AddTransient<INotificationHandler<CoreBanking.Core.Events.InsufficientFundsEvent>, InsufficientFundsEventHandler>();
...
            builder.Services.AddValidatorsFromAssembly(typeof(CreateAccountCommandValidator).Assembly);
            ...
            builder.Services.AddAutoMapper(cfg => { }, typeof(gRPC.Mappings.AccountGrpcProfile).Assembly);
